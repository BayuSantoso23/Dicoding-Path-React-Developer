document.addEventListener('DOMContentLoaded', function () {
  ...
  // Pengecekan sisa karakter yang dapat diinput
  ...
  // Notifikasi jumlah karakter yang masih bisa diinput
  document.getElementById('inputNama').addEventListener('focus', function () {
    console.log('inputNama: focus');
    document.getElementById('notifikasiSisaKarakter').style.visibility = 'visible';
  });

  // Menghilangkan (blur) sisa karakter jika sudah tidak menginput nama
  document.getElementById('inputNama').addEventListener('blur', function () {
    console.log('inputNama: blur');
    document.getElementById('notifikasiSisaKarakter').style.visibility = 'hidden';
  });

  // Menggunakan "change" yang sama dengan "input" untuk mendeteksi perubahan input
